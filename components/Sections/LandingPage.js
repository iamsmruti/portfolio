  ...
  return (
    <Box sx={{height: 'calc(100vh - 60px)', display: 'flex', alignContent: 'center', justifyContent: 'center'}}>
        <Stack sx={{ml: -1.5, mt: 'auto', mb: 'auto'}}>
            ...
            <a target={"_blank"} href="https://firebasestorage.googleapis.com/v0/b/portfolio-208ef.appspot.com/o/Smruti_Ranjan_Badatya.pdf?alt=media&token=d4e24099-c4b1-4811-9c21-fab16f0753ec" download>
